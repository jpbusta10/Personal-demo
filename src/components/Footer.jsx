      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            <span className="font-bold text-white text-lg">Juan Pablo Bustamante</span>
            <span className="text-sm">Video Software Developer</span>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 text-center text-sm">
          <p>© {currentYear} Juan Pablo Bustamante. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
